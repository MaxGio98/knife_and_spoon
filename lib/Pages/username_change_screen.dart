...
class ChangeUsernameScreen extends StatefulWidget {
  const ChangeUsernameScreen({Key key, @required Utente utente})
      : _utente = utente;
...
class _ChangeUsernameScreenState extends State<ChangeUsernameScreen> {
                          ...
                          Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintText:
                                      "Inserisci qui il tuo nuovo username",
                                  hintStyle:
                                      TextStyle(color: CustomColors.silver)),
  ...
  void checkValue() async {
    ...
    await checkChangeUsername(usernameController.text, context, _actualUser);
    setState(() {
      check = false;
    });
  }
